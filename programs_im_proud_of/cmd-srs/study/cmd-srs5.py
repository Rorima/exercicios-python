...
If the user chose "again" in a card, show that card in the 
same review session;

Currently working on self.review(). Legitimately save the user 
answers and try to apply the algorithm for the forgetting curve.
"""
import json
import time
