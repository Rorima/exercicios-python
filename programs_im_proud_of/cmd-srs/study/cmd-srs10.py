...
Currently working on: Option to add new cards;
working on self.add_to_deck(). Trying to find a 
way to add the new card to the main deck and then 
rewrite everything in the json file.

MAYBE I only need to open the file once to read the 
cards, and then add everything to a instance variable. 
